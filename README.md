    ...
    <div class="card">
      <div style="display:flex;justify-content:space-between;align-items:start;gap:18px;flex-wrap:wrap">
        ...
        <div style="min-width:220px;max-width:320px">
          <img src="https://via.placeholder.com/300x200?text=Foto+do+Protótipo" alt="Protótipo do Estacionamento Vertical Automatizado"/>
    ...
    <main>
      ...
      <article class="card section" id="desenvolvimento">
        ...
        <section id="estrutura">
          ...
          <img src="https://via.placeholder.com/300x200?text=Estrutura+Mecânica" alt="Estrutura Mecânica do protótipo"/>
        </section>
        ...
        <section id="integracao">
          ...
          <img src="https://via.placeholder.com/300x200?text=Arduino+e+Sensores" alt="Integração Eletrônica com Arduino e sensores"/>
        </section>
        ...
        <section id="diagrama">
          ...
          <img src="https://via.placeholder.com/300x200?text=Diagrama+de+Funcionamento" alt="Diagrama de Funcionamento do Estacionamento Automatizado"/>
        </section>
      </article>
