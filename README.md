...
<body>
  <div class="container">
    ...
    <nav class="card" aria-label="Sumário">
      <!-- Imagem ilustrativa acima do sumário -->
      <div style="text-align:center; margin-bottom:10px;">
        <p style="font-weight:bold; margin-bottom:5px;">Imagem Ilustrativa</p>
        <img src="https://i.postimg.cc/IMG-20250912-WA0059.jpg" alt="Imagem Ilustrativa" style="max-width:90%; border-radius:8px;"/>
      </div>
