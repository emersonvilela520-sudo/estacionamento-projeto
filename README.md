...
<body>
  <div class="container">
    ...
    <nav class="card" aria-label="Sumário">
      ...
      <a href="#imagem-ilustrativa">Imagem Ilustrativa</a>
    ...
    <div class="grid">
      <main>
        <!-- Imagem Ilustrativa acima de Integrantes -->
        <article class="card section" id="imagem-ilustrativa">
          <p style="text-align:center;font-weight:bold;margin-bottom:10px;">Imagem Ilustrativa</p>
          <img src="https://i.postimg.cc/IMG-20250912-WA0059.jpg" alt="Imagem Ilustrativa"/>
        </article>
        ...
        <article class="card section" id="integrantes">
          ...
          <p style="text-align:center;font-weight:bold;margin-top:15px;">Integrantes</p>
